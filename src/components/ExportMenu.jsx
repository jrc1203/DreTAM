...
const ExportMenu = ({ data, reportTitle = 'Claims Report' }) => {
    ...
    return (
        <div className="relative inline-block text-left" ref={menuRef}>
            ...
            {isOpen && (
                <div className="origin-top-right absolute right-0 mt-2 w-48 rounded-lg glass border border-white/20 dark:border-white/10 shadow-xl z-50 animate-fade-in-down">
                    <div className="py-1">
                        <button
