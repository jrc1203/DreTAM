            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    >
                        ...
                        <div className="mt-1">
                            <p className="text-3xl font-bold text-gray-800 dark:text-white">{totalClaims}</p>
                            <p className="text-sm font-medium text-purple-600 dark:text-purple-400">{formatCurrency(claims.reduce((sum, c) => sum + c.amount, 0))}</p>
                        </div>
                    </button>
                    ...
                    >
                        ...
                        <div className="mt-1">
                            <p className="text-3xl font-bold text-gray-800 dark:text-white">{pendingClaims}</p>
                            <p className="text-sm font-medium text-yellow-600 dark:text-yellow-400">{formatCurrency(totalAmountPending)}</p>
                        </div>
                    </button>
                    ...
                    >
                        ...
                        <div className="mt-1">
                            <p className="text-3xl font-bold text-gray-800 dark:text-white">{approvedClaims}</p>
                            <p className="text-sm font-medium text-green-600 dark:text-green-400">{formatCurrency(claims.filter(c => c.status === 'approved').reduce((sum, c) => sum + c.amount, 0))}</p>
                        </div>
                    </button>
                    ...
                    >
                        ...
                        <div className="mt-1">
                            <p className="text-3xl font-bold text-gray-800 dark:text-white">{rejectedClaims}</p>
                            <p className="text-sm font-medium text-red-600 dark:text-red-400">{formatCurrency(claims.filter(c => c.status === 'rejected').reduce((sum, c) => sum + c.amount, 0))}</p>
                        </div>
                    </button>
                </div>
