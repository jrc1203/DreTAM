                    ...
                    <div className="flex flex-col sm:flex-row gap-4 glass p-3 rounded-lg w-full md:w-auto">
                        <div className="relative">
                            <select
                                ...
                                className="appearance-none px-4 py-2 pr-10 rounded-lg text-sm outline-none focus:ring-2 focus:ring-[#6C63FF] bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-white cursor-pointer"
                            >
                            ...
                            <svg className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-500 dark:text-gray-400 pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
